...
export function ChessHistory({ records, onChange, onBack }: { records: ChessGameRecord[]; onChange: (records: ChessGameRecord[]) => void; onBack: () => void }) {
